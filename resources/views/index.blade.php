...
<link rel="stylesheet" type="text/css" href="{{ asset('ccs/tabbular.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('libs/animate/animate.min.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ asset('ccs/jquery.circliful.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('libs/owl_carousel/css/owl.carousel.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('libs/owl_carousel/css/owl.theme.css') }}">
...
<div id="owl-demo" class="owl-carousel owl-theme">
    ...
    <div class="item img-fluid"><img src="{{ asset('images/slide_3.jpg') }}" alt="slider-image">
    </div>
</div>
<!-- //Carousel End -->
@stop
...
<script type="text/javascript" src="{{ asset('js/jquery.circliful.js') }}"></script>
<script type="text/javascript" src="{{ asset('libs/wow/js/wow.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('libs/owl_carousel/js/owl.carousel.min.js') }}"></script>
