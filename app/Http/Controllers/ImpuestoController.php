...
class ImpuestoController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            if (session("empre")=="0") {
                ...
                $query = $model::select('*')->where("idEmpresa" , session("empre"));    
            }
    ...
    public function show(Request $request, $id)
    {
        ...
        if (session("empre")==0) {
            $dataTypeContent = $model->findOrFail($id);
        } else {
            $dataTypeContent = $model::where("idEmpresa", session("empre"))->findOrFail($id);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (session("empre")==0) {
            ...
            $data = $model::where("idEmpresa", session("empre"))->findOrFail($id);
        }
    ...
    public function store(Request $request)
    {
        ...
        $request["idEmpresa"] = session("empre");
        $request["estado"] = true;
        $request["esRetencion"] = true;
        $request["esCompra"] = true;
        $request["esVenta"] = true;
        $request["esPorcentaje"] = false;
        $request["esLibroImpuesto"] = true;
        date_default_timezone_set("America/Caracas");
        $request["fechaCreacion"] = date('d-m-Y H:i:s',time());
